  ...
  return (
    <div className="production-page">
      ...
      <header className="production-header">
        <h1>Dashboard</h1>
        <nav>
          <Link href="/production/edit">Edit</Link>
          <Link href="/production/view">View</Link>
          <Link href="/production/data">Data</Link>
          <Link href="/production/data/sales">Sales Data</Link>
          <Link href="/production/data/customers">Customer Data</Link>
          <Link href="/production/data/website">Website Data</Link>
        </nav>
      </header>
        ...
        <Card className="production-card">
         ...
         <Card className="production-card">
          <CardContent>
            ...
            rowNames={['Tagged', 'Seam-Ripped', 'Matched Panels', 'Sewn/Surged', 'Patch', 'Finished']}
            columnNames={['26', '28', '30', '32', '34', '36', '38']}
            cellContent={[
                [1, 4, 13, 4, 8, 3, 7],
                [1, 5, 3, 12, 25, 5, 7],
